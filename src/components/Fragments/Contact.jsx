    ...
    return (
        <Fragment>
          <section id='about' className='flex flex-col p-3 gap-y-5 justify-center text-white mt-24 md:mt-20 h-[50vh] md:h-[30vh] lg:h-[50vh]' style={heroStyle}>
              <h1 data-aos="fade-left" data-aos-duration="1000" className="text-2xl font-bold font-briem md:text-4xl lg:text-5xl text-center">Contact Us</h1>
          ...
          <section className='p-5 flex flex-col gap-y-5 mt-7 lg:w-3/5 lg:self-center'>
              <article className='flex flex-col justify-center gap-y-2'>
                  <h1 className='font-bold text-xl md:text-2xl'>Pemesanan</h1>
                  <hr className='border-red w-24 md:w-32 border-2 rounded-xl' />
              </article>
  
              <article>
                  <h2 className='w-92 text-2xl md:text-4xl font-bold'>Contact Us</h2>
              </article>
                  ...
                  <div className="flex flex-col gap-y-3 md:w-1/2">
                      <article className="flex flex-col gap-y-3">
                          <div className="flex flex-col gap-y-1">
                              <h3 className="font-bold text-xl md:text-2xl">Restaurant</h3>
                              <hr className="border-red w-32 border-2 rounded-xl" />
                              <h4 className="md:text-xl font-semibold">Alamat SteakHouse Delight</h4>
                          </div>
                          <p className="md:text-xl">Tubagus ismail dalam no 28/153B RT 0/3 RW 07 sekeloa coblong Gang 3 (Kos Ibu Uceu) COBLONG, 40134NG, Kota Bandung, Jawa Barat 40134</p>
                      </article>
  
                      <article className="flex flex-col gap-y-3">
                          <div className="flex flex-col gap-y-1">
                              <h3 className="font-bold text-xl md:text-2xl">Follow Us</h3>
                              <hr className="border-red w-20 md:w-28 border-2 rounded-xl" />
                          </div>
                          <ul className="flex gap-x-3">
                              <li className="fab fa-instagram md:text-xl"></li>
                              <li className="fab fa-youtube md:text-xl"></li>
                              <li className="fab fa-facebook md:text-xl"></li>
                          </ul>
                      </article>
                  </div>
